...
public class manhattanDistance {
    ...
    manhattanDistance( int[][] primary  )
    {
        this.primary=new node(primary,n,null,1);
    ...
    public boolean solve()
    {
       ...
       // explore.put(primary,primary.f_n);
        while(!pq.isEmpty())
        {
            ...
            {
                int count=0;
                System.out.println("\n................ Manhattan : Found goal state ..............\n From goal to primary ");
            ...
            {
                node n1= new node(list.get(i),main.n,mini,1);
        ...
        while(!pq.isEmpty())
        {
            ...
            for(int i=0;i<list.size();i++)
            {
                ...
                if(closed.containsKey(n1)) continue;

                if(explore.containsKey(n1) && explore.get(n1)<n1.f_n)
                {
                    explore.put(n1,n1.f_n);
                    pq.add(n1);
                }
                else if(!explore.containsKey(n1))
                {
                    pq.add(n1);
                    explore.put(n1,n1.f_n);
                }
